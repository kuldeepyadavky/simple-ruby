...
$db = {
    ...
    tasks: [{id: 1, title: "task 1", completed: true}, {id: 2, title: "task 2", completed: false}]
}
...
class Model
    ...
    def self.connect
        class_name = to_s.downcase.pluralize #users -> users
        puts "#{self} #{class_name} is getting initialized..."
...
puts tasks
#User -> u1, u2, u3
#User < Model @data User.data => user: {}
#Task < Model @Task Task.data => task: {}
